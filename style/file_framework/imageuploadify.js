    ...
    this.each(function() {
     ...
     <div class="imageuploadify well">
          ...
          <div class="imageuploadify-images-list text-center">
              <img src="/glummer/style/img/foto_file.png" style="width: 30%;margin: 0 auto">
              <span class='imageuploadify-message' style="width: 80%;margin: 0 auto;border: none;color: #666">Arraste as imagens para dentro do bloco</span>
              <button type="button" class="btn btn-default" style="width: 80%;margin: 0 auto;color: #666;border-color: #666">ou click aqui</button>
          </div>
      </div>
      `);
      ...
      button.mouseenter(function onMouseEnter(event) {
        button.css("background", "#666").css("color", "white");
      }).mouseleave(function onMouseLeave() {
        button.css("background", "white").css("color", "#666");
      });
