    ...
    <div class="mobileMenu">
      <div class="mobilemenu-block">
        ...
        <p>
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('home/news'); ?>">Artigos</a>
            </li>
            <li class="nav-item">
          ...
          <ul class="navbar-nav d-flex justify-content-between">
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('home/news'); ?>">
                <p class="item-navlink"> Artigos</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('home/produtos'); ?>">
                <p class="item-navlink"> Contatos</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link atAnc" href="#Contatos">
                <p class="item-navlink"> Precisa de ajuda?</p>
              </a>
            </li>
            <!-- 
              <li class="nav-item">
